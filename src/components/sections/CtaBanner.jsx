    ...
    <section className="py-24 bg-[#020202] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <div className="sc-card rounded-[2rem] p-12 relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-orange-600/10 blur-[80px] rounded-full pointer-events-none" />
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
              <a href="tel:+261348229857" className="flex items-center gap-3 text-white hover:text-orange-400 transition-colors">
                <Phone size={20} className="text-orange-500" />
                +261 34 82 298 57
              </a>
              <div className="hidden sm:block w-px h-6 bg-white/10" />
              <a href="mailto:hello@dabil.io" className="flex items-center gap-3 text-white hover:text-orange-400 transition-colors">
